    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#ddd8cf' }}>
      <div className="w-full max-w-sm space-y-8">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              style={{ backgroundColor: 'rgba(255,252,248,0.7)', border: '1px solid rgba(42,37,32,0.12)', color: '#2a2520', focusRingColor: '#9a7b50' } as React.CSSProperties}
            />
          </div>
          ...
          <div className="space-y-1.5">
            <label htmlFor="confirm-password" className="text-sm font-medium" style={{ color: '#2a2520' }}>Confirmar password</label>
            <div className="relative">
              <input
                id="confirm-password" type={showPassword ? 'text' : 'password'} value={confirmPassword}
        ...
        <p className="text-center text-sm" style={{ color: '#8a847a' }}>
          Já tens conta?{' '}
          <Link href="/login" className="font-medium hover:underline" style={{ color: '#2a2520' }}>Entrar</Link>
        </p>
      </div>
    </div>
  )
